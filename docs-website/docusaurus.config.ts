...
const config: Config = {
  title: "Repacked",
  tagline: "We Do the Setup, You Do the Magic.",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://repacked.dev",
  ...
  organizationName: "rukshan-dev", // Usually your GitHub org/user name.
  projectName: "repacked", // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Rukshan Fernando. Built with Docusaurus.`,
    },
    prism: {
